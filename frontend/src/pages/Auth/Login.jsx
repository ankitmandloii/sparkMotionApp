...
const Login = () => {
  ...
  return (
    <div
      className="min-h-screen w-full font-[Inter] flex justify-center items-center p-4 bg-cover bg-center"
      style={{
        backgroundColor: 'var(--color-surface-background)',
        backgroundImage: `linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(${backgroundImageLogin})`
      }}
    >
      <div className='flex flex-col justify-center items-center w-full max-w-md sm:max-w-lg md:max-w-xl mx-4'>
        <SparkMotionLogo />
        <div className="flex flex-col justify-center items-center bg-[var(--color-surface-card)] rounded-xl border border-[#454343] shadow-2xl w-full p-6 sm:p-8">
