      ...
      {showAcceptDecline ? (
        <div className="flex flex-col sm:flex-row justify-end sm:space-x-4 space-y-2 sm:space-y-0">
          <button
            ...
            className="px-4 py-2 bg-[var(--color-primary)] text-white rounded-md hover:opacity-80 transition-opacity duration-200  cursor-pointer"
          >
            {buttontxt?.accept || "Accept"}
          </button>
          <button
            ...
            className="px-4 py-2 bg-[var(--color-text-secondary)] text-white rounded-md hover:opacity-80 transition-opacity duration-200  cursor-pointer"
          >
            {buttontxt?.decline || "Decline"}
          </button>
        </div>
