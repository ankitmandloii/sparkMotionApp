        ...
        <div className="text-white m-4 w-full">
            <main>
                ...
                <div className="space-y-4">
                    ...
                    {/* Desktop / Large Table */}
                    <div
                        className={`hidden lg:block bg-[var(--color-surface-background)] rounded-2xl border border-[var(--border-color)] p-3 overflow-x-auto max-h-[290px] custom-scrollbar ${MAX_HEIGHT_CALC}`}
                    >
