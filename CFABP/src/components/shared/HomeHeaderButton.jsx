...
function HomeHeaderButton() {
    ...
    return (
        <div className='w-[417px] h-[50px] gap-4  flex '>
            ...
            <button
                onClick={() => { }}
                className="button-bg-gradient  w-[200px] hover:from-red-600 hover:to-red-700 text-white px-6 py-2.5 rounded-full font-medium text-sm transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
                View Schedule
            </button>
            <button
