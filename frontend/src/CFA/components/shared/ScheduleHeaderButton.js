...
const CUSTOM_COLORS = {
    stage: '#8B5CF6',    // Purple for Main Stage
    electronic: '#06B6D4', // Cyan/Blue for Electronic Stage (using the 'merch' color)
    acoustic: '#10B981',   // Green for Acoustic Stage (using the 'parking' color)
};

// --- New Stage Data Array for easier iteration ---
const STAGES = [
    { name: 'Main Stage', color: CUSTOM_COLORS.stage },
    { name: 'Electronic Stage', color: CUSTOM_COLORS.electronic },
    { name: 'Acoustic Stage', color: CUSTOM_COLORS.acoustic },
];
// -------------------------------------------------
